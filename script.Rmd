...
```{r anim_small, fig.width = 10}
library(gganimate)

finaldf = devpyr %>% filter(yr > 2000)
...
plot = plot + ylab("Median(Temp(Monthly Avg) - Reference) / (Degree Celius)")

anim = plot + transition_time(yr) + ease_aes('linear') + enter_fade()
